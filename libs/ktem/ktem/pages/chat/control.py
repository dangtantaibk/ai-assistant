        ...
        with gr.Row():
            ...
            self.btn_toggle_dark_mode.click(
                ...
                () => {
                    ...
                    const button = document.getElementById('toggle-dark-button');
                    const img = button.querySelector('img');
                    if (document.body.classList.contains('dark')) {
                        img.src = img.src.replace('dark_mode.svg', 'light_mode.svg');
                    } else {
                        img.src = img.src.replace('light_mode.svg', 'dark_mode.svg');
                    }
                }
                """,
            )
